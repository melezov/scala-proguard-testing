...
import hr.element.spt.lda.Country;
import hr.element.spt.lda.LegalDrinkingAgeVerificatorFactory;

public class YouthAlchocolismPrevention {
    public static boolean isLegalToDrink(final Country country, final int age) {
        return !LegalDrinkingAgeVerificatorFactory.INSTANCE.getAgeVerificator(country).isUnderage(age);
    }
